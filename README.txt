...
B3: re-scaffold db: (không nên bởi sẽ xóa các viewModel đã tạo ở folder Models)
dotnet ef dbcontext scaffold Name=ConnectionStrings:DbConnection Microsoft.EntityFrameworkCore.SqlServer --output-dir Models1 --force
B4: Liên hệ Phong :)
